...
- [Download the Mac app](https://bridgepit.com/downloads/BridgePit-mac-1.4.30.dmg). Open the DMG, drag BridgePit into Applications, then launch it.
...
5. In TradingView, open a chart of the instrument you chose in section 02, any timeframe. Click Pine Editor at the bottom of the chart. Replace its contents with the copied code, Save it as a private script under any file name, then Add to chart. On the chart it appears as BridgePit 14/28 SMA for your strategy's name.
